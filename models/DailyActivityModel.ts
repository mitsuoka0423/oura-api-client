...
export class DailyActivityModel {
    /**
    * 5-minute activity classification for the activity period: * ```0``` non wear * ```1``` rest * ```2``` inactive * ```3``` low activity * ```4``` medium activity * ```5``` high activity
    */
    'class5Min'?: string;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "activeCalories",
            "baseName": "active_calories",
            "type": "number",
            "format": ""
        },
        {
            "name": "averageMetMinutes",
            "baseName": "average_met_minutes",
            "type": "number",
            "format": ""
        },
        {
        ...
        {
            "name": "equivalentWalkingDistance",
            "baseName": "equivalent_walking_distance",
            "type": "number",
            "format": ""
        },
        {
            "name": "highActivityMetMinutes",
            "baseName": "high_activity_met_minutes",
            "type": "number",
            "format": ""
        },
        {
            "name": "highActivityTime",
            "baseName": "high_activity_time",
            "type": "number",
            "format": ""
        },
        {
            "name": "inactivityAlerts",
            "baseName": "inactivity_alerts",
            "type": "number",
            "format": ""
        },
        {
            "name": "lowActivityMetMinutes",
            "baseName": "low_activity_met_minutes",
            "type": "number",
            "format": ""
        },
        {
            "name": "lowActivityTime",
            "baseName": "low_activity_time",
            "type": "number",
            "format": ""
        },
        {
            "name": "mediumActivityMetMinutes",
            "baseName": "medium_activity_met_minutes",
            "type": "number",
            "format": ""
        },
        {
            "name": "mediumActivityTime",
            "baseName": "medium_activity_time",
            "type": "number",
            "format": ""
        },
        {
        ...
        {
            "name": "metersToTarget",
            "baseName": "meters_to_target",
            "type": "number",
            "format": ""
        },
        {
            "name": "nonWearTime",
            "baseName": "non_wear_time",
            "type": "number",
            "format": ""
        },
        {
            "name": "restingTime",
            "baseName": "resting_time",
            "type": "number",
            "format": ""
        },
        {
            "name": "sedentaryMetMinutes",
            "baseName": "sedentary_met_minutes",
            "type": "number",
            "format": ""
        },
        {
            "name": "sedentaryTime",
            "baseName": "sedentary_time",
            "type": "number",
            "format": ""
        },
        {
        ...
        {
            "name": "targetCalories",
            "baseName": "target_calories",
            "type": "number",
            "format": ""
        },
        {
            "name": "targetMeters",
            "baseName": "target_meters",
            "type": "number",
            "format": ""
        },
        {
            "name": "totalCalories",
            "baseName": "total_calories",
            "type": "number",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return DailyActivityModel.attributeTypeMap;
    }
