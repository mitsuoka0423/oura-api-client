...
/**
 * Check if a given object implements the ActivityContributors interface.
 */
export function instanceOfActivityContributors(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ActivityContributorsFromJSON(json: any): ActivityContributors {
    return ActivityContributorsFromJSONTyped(json, false);
}

export function ActivityContributorsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ActivityContributors {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'meetDailyTargets': !exists(json, 'meet_daily_targets') ? undefined : json['meet_daily_targets'],
        'moveEveryHour': !exists(json, 'move_every_hour') ? undefined : json['move_every_hour'],
        'recoveryTime': !exists(json, 'recovery_time') ? undefined : json['recovery_time'],
        'stayActive': !exists(json, 'stay_active') ? undefined : json['stay_active'],
        'trainingFrequency': !exists(json, 'training_frequency') ? undefined : json['training_frequency'],
        'trainingVolume': !exists(json, 'training_volume') ? undefined : json['training_volume'],
    };
}

export function ActivityContributorsToJSON(value?: ActivityContributors | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
