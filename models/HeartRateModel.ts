...
/**
 * Check if a given object implements the HeartRateModel interface.
 */
export function instanceOfHeartRateModel(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "bpm" in value;
...
export function HeartRateModelFromJSON(json: any): HeartRateModel {
    return HeartRateModelFromJSONTyped(json, false);
}

export function HeartRateModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): HeartRateModel {
...
export function HeartRateModelToJSON(value?: HeartRateModel | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
