...
import {
    DailyActivityModelFromJSON,
    DailyActivityModelFromJSONTyped,
    DailyActivityModelToJSON,
} from './DailyActivityModel';
...
export interface DailyActivityResponse {
    /**
     * 
     * @type {Array<DailyActivityModel>}
     * @memberof DailyActivityResponse
     */
...
/**
 * Check if a given object implements the DailyActivityResponse interface.
 */
export function instanceOfDailyActivityResponse(value: object): boolean {
    let isInstance = true;
...
export function DailyActivityResponseFromJSON(json: any): DailyActivityResponse {
    return DailyActivityResponseFromJSONTyped(json, false);
}

export function DailyActivityResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DailyActivityResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(DailyActivityModelFromJSON)),
        'nextToken': !exists(json, 'next_token') ? undefined : json['next_token'],
    };
}

export function DailyActivityResponseToJSON(value?: DailyActivityResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'data': ((value.data as Array<any>).map(DailyActivityModelToJSON)),
