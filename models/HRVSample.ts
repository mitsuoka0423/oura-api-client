...
/**
 * Check if a given object implements the HRVSample interface.
 */
export function instanceOfHRVSample(value: object): boolean {
    let isInstance = true;
...
export function HRVSampleFromJSON(json: any): HRVSample {
    return HRVSampleFromJSONTyped(json, false);
}

export function HRVSampleFromJSONTyped(json: any, ignoreDiscriminator: boolean): HRVSample {
...
export function HRVSampleToJSON(value?: HRVSample | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
