...
export class SessionModel {
    ...
    */
    'endDatetime': string;
    /**
    * The session type: * ```breathing``` * ```meditation``` * ```nap``` * ```relaxation``` * ```rest``` * ```body_status```
    */
    'type': string;
    'heartRate'?: HRTSample;
    'heartRateVariability'?: HRVSample;
    /**
    * The user's selected mood after the session: * ```bad``` * ```worse``` * ```same``` * ```good``` * ```great```
    */
    'mood'?: string;
    'motionCount'?: Sample;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "baseName": "heart_rate_variability",
            "type": "HRVSample",
            "format": ""
        },
        {
        ...
        {
            "name": "motionCount",
            "baseName": "motion_count",
            "type": "Sample",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return SessionModel.attributeTypeMap;
    }
