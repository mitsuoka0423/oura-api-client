...
/**
 * Check if a given object implements the WorkoutResponse interface.
 */
export function instanceOfWorkoutResponse(value: object): boolean {
    let isInstance = true;
...
export function WorkoutResponseFromJSON(json: any): WorkoutResponse {
    return WorkoutResponseFromJSONTyped(json, false);
}

export function WorkoutResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkoutResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(WorkoutModelFromJSON)),
        'nextToken': !exists(json, 'next_token') ? undefined : json['next_token'],
    };
}

export function WorkoutResponseToJSON(value?: WorkoutResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'data': ((value.data as Array<any>).map(WorkoutModelToJSON)),
