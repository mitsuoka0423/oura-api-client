...
export interface SessionsRouteSessionGetRequest {
    startDate?: Date;
    endDate?: Date;
    nextToken?: string;
}
...
export interface SessionsApiInterface {
     ...
     */
    sessionsRouteSessionGetRaw(requestParameters: SessionsRouteSessionGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SessionResponse>>;

    /**
     * Returns available Oura session data for the specified Oura user within a given timeframe
     * Get Sessions
     */
    sessionsRouteSessionGet(requestParameters: SessionsRouteSessionGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SessionResponse>;
...
export class SessionsApi extends runtime.BaseAPI implements SessionsApiInterface {
     ...
     * Get Sessions
     */
    async sessionsRouteSessionGetRaw(requestParameters: SessionsRouteSessionGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SessionResponse>> {
     ...
     * Get Sessions
     */
    async sessionsRouteSessionGet(requestParameters: SessionsRouteSessionGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SessionResponse> {
        const response = await this.sessionsRouteSessionGetRaw(requestParameters, initOverrides);
