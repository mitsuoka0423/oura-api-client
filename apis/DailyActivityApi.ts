...
import {
    DailyActivityResponseFromJSON,
    DailyActivityResponseToJSON,
} from '../models';

export interface DailyActivityRouteDailyActivityGetRequest {
    startDate?: Date;
    endDate?: Date;
    nextToken?: string;
}
...
/**
 * DailyActivityApi - interface
 * 
 * @export
 * @interface DailyActivityApiInterface
 */
export interface DailyActivityApiInterface {
    /**
     ...
     * @memberof DailyActivityApiInterface
     */
    dailyActivityRouteDailyActivityGetRaw(requestParameters: DailyActivityRouteDailyActivityGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DailyActivityResponse>>;

    /**
     * Returns Oura Daily Activity data for the specified Oura user within a given timeframe
     * Get Daily Activity
     */
    dailyActivityRouteDailyActivityGet(requestParameters: DailyActivityRouteDailyActivityGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DailyActivityResponse>;
 ...
 * 
 */
export class DailyActivityApi extends runtime.BaseAPI implements DailyActivityApiInterface {

    /**
     * Returns Oura Daily Activity data for the specified Oura user within a given timeframe
     * Get Daily Activity
     */
    async dailyActivityRouteDailyActivityGetRaw(requestParameters: DailyActivityRouteDailyActivityGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DailyActivityResponse>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => DailyActivityResponseFromJSON(jsonValue));
    }
     ...
     * Get Daily Activity
     */
    async dailyActivityRouteDailyActivityGet(requestParameters: DailyActivityRouteDailyActivityGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DailyActivityResponse> {
        const response = await this.dailyActivityRouteDailyActivityGetRaw(requestParameters, initOverrides);
