...
/**
 * PersonalInfoApi - interface
 * 
 * @export
 * @interface PersonalInfoApiInterface
 */
export interface PersonalInfoApiInterface {
    /**
     * Returns personal info data for the specified Oura user.
     * @summary Get Personal Info
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof PersonalInfoApiInterface
     */
    personalInfoRouteGetRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PersonalInfoResponse>>;

    /**
     * Returns personal info data for the specified Oura user.
     * Get Personal Info
     */
    personalInfoRouteGet(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PersonalInfoResponse>;
 ...
 * 
 */
export class PersonalInfoApi extends runtime.BaseAPI implements PersonalInfoApiInterface {

    /**
     * Returns personal info data for the specified Oura user.
     * Get Personal Info
     */
    async personalInfoRouteGetRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PersonalInfoResponse>> {
     ...
     * Get Personal Info
     */
    async personalInfoRouteGet(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PersonalInfoResponse> {
        const response = await this.personalInfoRouteGetRaw(initOverrides);
