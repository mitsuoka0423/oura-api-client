...
export interface TagsRouteTagGetRequest {
    startDate?: Date;
    endDate?: Date;
    nextToken?: string;
}
...
export interface TagsApiInterface {
     ...
     */
    tagsRouteTagGetRaw(requestParameters: TagsRouteTagGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<TagResponse>>;

    /**
     * Returns Oura tags data for the specified Oura user within a given timeframe
     * Get Tags
     */
    tagsRouteTagGet(requestParameters: TagsRouteTagGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<TagResponse>;
...
export class TagsApi extends runtime.BaseAPI implements TagsApiInterface {
     ...
     * Get Tags
     */
    async tagsRouteTagGetRaw(requestParameters: TagsRouteTagGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<TagResponse>> {
     ...
     * Get Tags
     */
    async tagsRouteTagGet(requestParameters: TagsRouteTagGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<TagResponse> {
        const response = await this.tagsRouteTagGetRaw(requestParameters, initOverrides);
