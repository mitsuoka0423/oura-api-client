...
import {
    WorkoutResponseFromJSON,
    WorkoutResponseToJSON,
} from '../models';

export interface WorkoutsRouteWorkoutGetRequest {
    startDate?: Date;
    endDate?: Date;
    nextToken?: string;
}
...
/**
 * WorkoutsApi - interface
 * 
 * @export
 * @interface WorkoutsApiInterface
 */
export interface WorkoutsApiInterface {
    /**
     ...
     * @memberof WorkoutsApiInterface
     */
    workoutsRouteWorkoutGetRaw(requestParameters: WorkoutsRouteWorkoutGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<WorkoutResponse>>;

    /**
     * Returns available Oura workout data for the specified Oura user within a given timeframe
     * Get Workouts
     */
    workoutsRouteWorkoutGet(requestParameters: WorkoutsRouteWorkoutGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<WorkoutResponse>;
 ...
 * 
 */
export class WorkoutsApi extends runtime.BaseAPI implements WorkoutsApiInterface {

    /**
     * Returns available Oura workout data for the specified Oura user within a given timeframe
     * Get Workouts
     */
    async workoutsRouteWorkoutGetRaw(requestParameters: WorkoutsRouteWorkoutGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<WorkoutResponse>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => WorkoutResponseFromJSON(jsonValue));
    }
     ...
     * Get Workouts
     */
    async workoutsRouteWorkoutGet(requestParameters: WorkoutsRouteWorkoutGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<WorkoutResponse> {
        const response = await this.workoutsRouteWorkoutGetRaw(requestParameters, initOverrides);
